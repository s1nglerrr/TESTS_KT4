...
namespace TestProject1
{
    public class LibraryServiceTests
    {
        ...
        public void BorrowBook_StudentNotFound_ReturnsUnsuccessfulResult()
        {
            ...
            Assert.Equal("Студент не найден", _result.Message);
        }
        ...
        public void BorrowBook_BookNotFound_ReturnsUnsuccessfulResult()
        {
            ...
            Assert.False(_result.Success);
            Assert.Equal("Книга не найдена", _result.Message);
        }
        ...
        public void BorrowBook_BookNotAvailable_ReturnsUnsuccessfulResult()
        {
            ...
            Assert.False(_result.Success);
            Assert.Equal("Книга уже выдана", _result.Message);
        }
        ...
        public void BorrowBook_SuccessfulBorrow_ReturnsSuccessResult()
        {
            ...
            Assert.Equal("Книга 'C#' успешно выдана студенту Иван Иванов", _result.Message);
            Assert.False(_availableBook.IsAvailable);
            _bookRepoMock.Verify(x => x.UpdateBook(_availableBook));
            _notificationMock.Verify(x => x.SendSuccessNotification("Иван Иванов", "C#"));
        }
    }
}